...
export const TimerStepEditModal = ({
  isOpen,
  initialSeconds,
  title,
  onOpenChange,
      ...
      <Modal.Container placement="center">
        <Modal.Dialog>
          ...
          <Modal.Body className="px-6 py-4">
            <form id="edit-timer-step-form" onSubmit={handleSubmit}>
          ...
          <Modal.Footer>
            ...
            <Button type="submit" form="edit-timer-step-form" variant="primary" slot="close">
              {t($ => $.settings.sections.timer.groups.customSteps.editModal.submitBtn.text)}
            </Button>
          </Modal.Footer>
        </Modal.Dialog>
      </Modal.Container>
