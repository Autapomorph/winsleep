...
export const PresetEditModal = ({ isOpen, initialSeconds, onOpenChange, onSave }: Props) => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    onSave(Math.min(total, MAX_SECONDS));
  };
    ...
    <Modal.Backdrop isOpen={isOpen} onOpenChange={onOpenChange}>
      <Modal.Container placement="center">
        <Modal.Dialog>
          ...
          <Modal.Header>
            <Modal.Heading>
              {t($ => $.settings.sections.timer.groups.presets.presetEditModal.title)}
            </Modal.Heading>
          </Modal.Header>

          <Modal.Body className="px-6 py-4">
            <form id="edit-preset-form" onSubmit={handleSubmit}>
          ...
          <Modal.Footer>
            ...
            <Button type="submit" form="edit-preset-form" variant="primary">
              {t($ => $.settings.sections.timer.groups.presets.presetEditModal.submitBtn.text)}
            </Button>
          </Modal.Footer>
        </Modal.Dialog>
      </Modal.Container>
