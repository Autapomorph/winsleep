...
export const DefaultTimerEditModal = ({ isOpen, initialSeconds, onOpenChange, onSave }: Props) => {
    ...
    <Modal.Backdrop isOpen={isOpen} onOpenChange={onOpenChange}>
      <Modal.Container placement="center">
        <Modal.Dialog>
          ...
          <Modal.Header>
            <Modal.Heading>
              {t($ => $.settings.sections.timer.groups.basic.defaultTimer.editModal.title)}
            </Modal.Heading>
          </Modal.Header>

          <Modal.Body className="px-6 py-4">
            <form id="edit-default-timer-form" onSubmit={handleSubmit}>
          ...
          <Modal.Footer>
            ...
            <Button type="submit" form="edit-default-timer-form" variant="primary" slot="close">
              {t($ => $.settings.sections.timer.groups.basic.defaultTimer.editModal.submitBtn.text)}
            </Button>
          </Modal.Footer>
        </Modal.Dialog>
      </Modal.Container>
